...
<head>
    ...
    <title> Edit Order - Bookstore Administration
    </title>
    ...
    <form action="update_order" method="post" id="orderForm">
                <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <tr>
                                        ...
                                        <td align="left"><input type="text" class="input-focus usid" id="firstname" name="firstname" size="45" value="${order.firstname}" /></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">Last Name:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="lastname" name="lastname" size="45" value="${order.lastname}" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <td class="text-right td-label">Recipient Phone:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="phone" name="phone" size="45" value="${order.phone}"/></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">Address Line1:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="address1" name="address1" size="45" value="${order.addressLine1}"/></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">Address Line2:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="address2" name="address2" size="45" value="${order.addressLine2}"/></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">City:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="city" name="city" size="45" value="${order.city}"/></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">State:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="state" name="state" size="45" value="${order.state}"/></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right td-label">Zip Code:</td>
                                        <td align="left"><input type="text" class="input-focus usid" id="zipCode" name="zipCode" size="45" value="${order.zipcode}"/></td>
                                    </tr>
                                    <tr>
										...
										<tr>
											...
											<td><span class="order-status order-shipped fontsize12px">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="order-status order-shipped fontsize12px">
                                                 ...
                                                 <td><a href="remove_book_from_order?id=${orderDetail.book.bookId}"><i
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-primary btn-test" href="javascript:showAddBookPopup()"><b>Add Books</b></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <input type="button" value="Cancel" class="btn btn-primary btn-test" onclick="javascript:window.location.href='list_order';"/>
                    </div>
